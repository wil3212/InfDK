...
\label{sec:org7154cbd}
\subsection{Estruturas}
\label{sec:org892b55c}
...
\label{sec:org4ba4671}
\subsubsection{Renderização}
\label{sec:orgf832e64}
...
\label{sec:org23582ce}
\subsection{Utilizando bash:}
\label{sec:org0278d41}
\begin{enumerate}
...
\item Atualmente, ainda não foi implementada atravez de GUI o recebimento do nome do jogador para guardar seu ranking;
...
\item A opção 'Ranking' mostra os top 10 scores com os respectivos nomes dos jogadores;
\end{itemize}
\subsection{Jogabilidade:}
\label{sec:orgf156817}
\begin{itemize}
