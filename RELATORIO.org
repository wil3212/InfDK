...
- Atualmente, ainda não foi implementada atravez de GUI o recebimento do nome do jogador para guardar seu ranking;
  O jogador deve informar seu nome no terminal e apertar enter (o nome deve ter até 20 caracteres), ficando salvo a posição do jogador no ranking;
